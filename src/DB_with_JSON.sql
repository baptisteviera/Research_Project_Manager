...
create table appelprojet (
	...
	membrescomitepersonne JSON not null
...
from propositionprojet inner join appelprojet on
propositionprojet.idappelprojet=appelprojet.id 
where propositionprojet.reponse = 'acceptation' group by appelprojet.idorganisme;
...
/*Afficher l'id des propositionprojet avec leur budget total et le montant et le type de financement des lignes budgetaires*/

create view propositionprojet_budget_lignes_budgetaires as select id, budget, 
CAST(lb ->>'montant' AS INTEGER) AS montant, 
lb->>'typefinancement' AS typefinancement 
FROM propositionprojet, JSON_ARRAY_ELEMENTS(propositionprojet.lignesbudgetaires) lb order by id;


/*Afficher l'id de l'appelprojet, le nom de l'organisme qui l'a publié et les membrescomitepersonne*/

/*Methode1*/

create view membrecomitepersonne_appelprojet_organisme as SELECT appelprojet.id, appelprojet.idorganisme,  mcp->>'nom' AS nom, mcp->>'mail' AS mail
FROM appelprojet  JOIN JSON_ARRAY_ELEMENTS(appelprojet.membrescomitepersonne) mcp ON TRUE;

/*Methode2*/

create view membrecomitepersonne_appelprojet_organisme_version2 as SELECT ap.id, ap.idorganisme, mcp.* 
FROM appelprojet ap, JSON_TO_RECORDSET(membrescomitepersonne) mcp (nom TEXT, mail TEXT);
...
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (1, '2020-01-28', '2020-07-04', 'Accounting', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', 'Dietrich Inc','[{"nom":"Dupont","mail":"fsavdsqdbh@gmail.com"},{"nom":"Vertu","mail":"jhdfhdb@gmail.com"}]');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (2, '2020-04-30', '2020-08-16', 'Training', 'Fusce consequat. Nulla nisl. Nunc nisl.', 'HaagKihn', '{"nom":"Bertrand","mail":"bfdbhfsbf@gmail.com"}');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (3, '2020-05-25', '2020-08-13', 'Services', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', 'Reilly LLC','{"nom":"azerty","mail":"jgdjsbcnb@gmail.com"}');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (4, '2020-03-22', '2020-07-07', 'Human Resources', 'Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 'Runte-Schroeder','{"nom":"gertrude","mail":"hdbsncdbdksjb@gmail.com"}');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (5, '2020-03-14', '2020-07-02', 'Marketing', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', 'Bahringer, Goyette and Kunze','{"nom":"Brand","mail":"bhdfhsdb@gmail.com"}');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (6, '2020-04-23', '2020-07-19', 'Research and Development', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 'Dietrich Inc','{"nom":"truc","mail":"cvdbfbdj@gmail.com"}');
insert into appelprojet (id, datelancement, datefin, theme, description, idorganisme, membrescomitepersonne) values (7, '2020-02-03', '2020-08-04', 'Support', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'HaagKihn','{"nom":"Roti","mail":"jghjhbdfhjbsfd@gmail.com"}');
...
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (1, 82454, '2020-02-07', '2020-04-11', 'acceptation', 1,'[{"montant":80000,"objetglobal":"nunc","typefinancement":"fonctionnement"},{"montant":2454,"objetglobal":"tempus","typefinancement":"materiel"}]');
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (4, 86690, '2020-03-07', '2020-03-25', 'refus', 1,'[{"montant":43345,"objetglobal":"in","typefinancement":"fonctionnement"},{"montant":43345,"objetglobal":"leo","typefinancement":"materiel"}]');
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (5, 77426, '2020-05-23', '2020-06-07', 'acceptation', 6,'[{"montant":70000,"objetglobal":"etiam","typefinancement":"fonctionnement"},{"montant":7426,"objetglobal":"arcu","typefinancement":"materiel"}]');
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (3, 64934, '2020-05-20', '2020-06-05', 'refus', 2,'[{"montant":60000,"objetglobal":"in","typefinancement":"fonctionnement"},{"montant":4934,"objetglobal":"cum","typefinancement":"materiel"}]');
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (6, 61952, '2020-04-11', '2020-05-28', 'acceptation', 7,'[{"montant":60000,"objetglobal":"nullam","typefinancement":"fonctionnement"},{"montant":1952,"objetglobal":"fermantum","typefinancement":"materiel"}]');
insert into propositionprojet (id, budget, datedeposition , datereponse , reponse , idappelprojet,lignesbudgetaires ) values (2, 52591, '2020-06-06', NULL, NULL, 3,'[{"montant":2591,"objetglobal":"mattis","typefinancement":"fonctionnement"},{"montant":50000,"objetglobal":"elit","typefinancement":"materiel"}]');
...
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (1, 80000, '{"typefinancement":"fonctionnement"}','2020-06-07', 1, 1, 4, 1);
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (2, 2454,  '{"typefinancement":"materiel"}','2020-05-13', 3, 1, 2, 1);
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (3, 25000, '{"typefinancement":"fonctionnement"}','2020-06-12', 5, 2, 7, 2);
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (4, 500, '{"typefinancement":"materiel"}','2020-05-07', 5, 2, 6, 2);
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (5, 1100, '{"typefinancement":"fonctionnement"}', '2020-04-07', 10 , 3, 12, 3);
insert into depenses  (id , montant , typefinancement , daterealisation, iddemandemembreprojet , iddemandeprojet , idvalidemembreprojet , idvalideprojet ) values (6, 14500, '{"typefinancement":"materiel"}','2020-04-07', 11, 3, 12, 3);
